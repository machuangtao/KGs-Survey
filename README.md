# KGs-Survey
- This is a repository of KGs survey paper that will be updated periodically. Last update: 28 May, 2023
...
<table class="tg">
  ...
  <tr>
    ...
    <td class="tg-yw4l">A benchmark and comprehensive survey on knowledge graph entity alignment via representation learning</td>
   ...
   <tr>
    ...
    <td class="tg-yw4l">An Overview of Methods and Tools for Extraction of Knowledge for COVID-19 from Knowledge Graphs</td>
...
reasoning, and inconsistency checking</td>
   ...
   <tr>
    ...
    <td class="tg-yw4l">Knowledge graph and knowledge reasoning: A systematic review</td>
...
reasoning, and inconsistency checking</td>
  ...
  <tr>
   ...
   <tr>
    ...
    <td class="tg-yw4l">A Systematic Review of Deep Knowledge Graph-Based Recommender Systems, with Focus on Explainable Embeddings</td>
    ...
    <td class="tg-yw4l">Categorization of knowledge graph based recommendation methods and benchmark datasets from the perspectives of application scenarios: A comprehensive survey</td>
  ...
  <tr>
    ...
    <td class="tg-yw4l">A Decade of Knowledge Graphs in Natural Language Processing: A Survey</td>
  ...
  <tr>
    ...
    <td class="tg-yw4l">Knowledge Graph Embedding: A Survey from the Perspective of Representation Spaces</td>
    <td class="tg-yw4l">arXiv</td>
    <td class="tg-yw4l">2022</td>
    <td class="tg-yw4l">KGs Representation Learning</td>
  ...
  <tr>
    ...
    <td class="tg-yw4l">Knowledge-Graph-Enabled Biomedical Entity Linking: A Survey</td>
  ...
  <tr>
    ...
    <td class="tg-yw4l">From Data to Wisdom: Biomedical Knowledge Graphs for Real-World Data Insights</td>
  ...
  <tr>
    ...
    <td class="tg-yw4l">Towards electronic health record-based medical knowledge graph construction, completion, and applications: A literature study</td>
    ...
    <td class="tg-yw4l">A Survey on Multimodal Knowledge Graphs: Construction, Completion and Applications</td>
  ...
  <tr>
    ...
    <td class="tg-yw4l">A Review of Knowledge Graph-Based Reasoning Technology in the Operation of Power Systems</td>
  ...
  <tr>
   ...
   <tr>
    ...
    <td class="tg-yw4l">Research and application of intelligent search for knowledge graph of power grid dispatch and control</td>
